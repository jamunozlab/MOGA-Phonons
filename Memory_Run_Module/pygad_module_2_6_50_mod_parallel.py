...
out_path = '/Users/jamunoz/Documents/GitHub/MOGA-Phonons/Memory_Run_Module/' + root + '/'
...
def on_generation(ga_instance):
    ...
    t2 = time.time()
    print("Time is", np.round(t2 - t1), "Best solution fitness vector:",best_solution_fitness)
...
if __name__ == '__main__':
    ...
    ga_instance = pygad.GA(
        ...
        parallel_processing=["process", 4],  # adjust 8 to your machine
